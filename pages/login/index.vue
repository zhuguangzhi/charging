    ...
    <view>
        ...
        <view>
            <view>
                ...
                <button class='bottom' type='primary' open-type="getPhoneNumber" withCredentials="true" lang="zh_CN" @getphonenumber="getPhoneNumber">
                    授权登录
                </button>
            </view>
        </view>
	...
	export default {
		...
		methods:{
			...
			async getPhoneNumber(phone) {
				...
				await ApiBase(login.GetUserPhone({
